...
import { AurinkoAccount } from './AurinkoAccount.js'
import { AurinkoEmailMessage } from './AurinkoEmailMessage.js'
import { AurinkoEmailBody } from './AurinkoEmailBody.js'
import { AurinkoCalendarEvent } from './AurinkoCalendarEvent.js'
...
// Aurinko (Gmail + Calendar via Aurinko) associations
AurinkoAccount.belongsTo(Company, { foreignKey: 'companyId', as: 'company' })
AurinkoAccount.belongsTo(User, { foreignKey: 'userId', as: 'user' })
AurinkoEmailMessage.belongsTo(AurinkoAccount, { foreignKey: 'accountId', as: 'account' })
AurinkoEmailMessage.belongsTo(Lead, { foreignKey: 'leadId', as: 'lead' })
AurinkoEmailMessage.belongsTo(Workspace, { foreignKey: 'workspaceId', as: 'workspace' })
AurinkoEmailMessage.hasOne(AurinkoEmailBody, { foreignKey: 'messageId', as: 'body' })
AurinkoEmailBody.belongsTo(AurinkoEmailMessage, { foreignKey: 'messageId', as: 'message' })
AurinkoCalendarEvent.belongsTo(AurinkoAccount, { foreignKey: 'accountId', as: 'account' })
