...
export const InvoiceItem = sequelize.define(
  'InvoiceItem',
  {
    ...
    servicePeriodStart: { type: DataTypes.DATEONLY, allowNull: true, field: 'service_period_start' },
    servicePeriodEnd: { type: DataTypes.DATEONLY, allowNull: true, field: 'service_period_end' },
  },
