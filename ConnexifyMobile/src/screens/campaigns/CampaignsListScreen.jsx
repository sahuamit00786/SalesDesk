...
const CampaignsListScreen = ({ navigation }) => {
  ...
  return (
    <View style={[st.root, { backgroundColor: theme.colors.background }]}>
      <View style={[st.header, { backgroundColor: theme.colors.surface, paddingTop: insets.top + spacing.sm, borderBottomColor: theme.colors.borderLight }]}>
        <Text style={[st.title, { color: theme.colors.textPrimary }]}>Campaigns</Text>
...
const st = StyleSheet.create({
  root:      { flex: 1 },
  header:    { paddingHorizontal: spacing.base, paddingBottom: spacing.sm, borderBottomWidth: 1 },
