...
router.delete('/folders/:id', requirePermission('documents', 'edit'), documentsController.deleteFolderWithContents)
...
router.delete('/:id', requirePermission('documents', 'edit'), documentsController.deleteDocument)
...
router.delete('/:id/folders/:folderId', requirePermission('documents', 'edit'), documentsController.removeDocumentFolder)
router.post('/:id/move-folder', requirePermission('documents', 'edit'), documentsController.moveDocumentFolder)
