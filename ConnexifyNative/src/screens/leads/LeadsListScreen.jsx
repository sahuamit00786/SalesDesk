...
const LeadsListScreen = ({ navigation }) => {
  ...
  const handleSort         = (s) => { setSort(s); fetchLeads(true); };
  ...
  const removeFilter = (key) => {
    if (key === 'createdRange')       setFilters({ createdFrom: null, createdTo: null });
    else if (key === 'followUpRange') setFilters({ followUpFrom: null, followUpTo: null });
    else {
    ...
    <View style={s.root}>
      ...
      <View style={s.header}>
        <View style={s.titleRow}>
          ...
          <Text style={s.pageTitle}>Leads</Text>
