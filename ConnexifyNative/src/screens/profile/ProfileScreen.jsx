...
const SettingRow = ({ icon, title, value, onPress, rightEl, theme }) => {
  ...
  return (
    ...
    >
      <View style={[s.iconWrap, { backgroundColor: theme.colors.primaryLight }]}>
...
const ProfileScreen = ({ navigation }) => {
  ...
  return (
    <View style={s.root}>
      <AppHeader title="My Profile" navigation={navigation} />
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.section}>
          ...
          />
          <Divider />
          <SettingRow icon="bell-outline" title="Notifications" onPress={() => navigation.navigate('Notifications')} theme={theme} />
        </View>
        ...
        <View style={s.section}>
          <Text style={s.sectionTitle}>HR</Text>
          <SettingRow icon="calendar-account-outline" title="Leave"        onPress={() => navigation.navigate('Leave')}        theme={theme} />
          <Divider />
          <SettingRow icon="calendar-month-outline"   title="Calendar"     onPress={() => navigation.navigate('Calendar')}     theme={theme} />
        </View>

        <View style={s.section}>
          <Text style={s.sectionTitle}>Tools</Text>
          <SettingRow icon="phone-log"        title="Call History" onPress={() => navigation.navigate('CallSync')}   theme={theme} />
          <Divider />
          <SettingRow icon="bullhorn-outline" title="Campaigns"    onPress={() => navigation.navigate('Campaigns')} theme={theme} />
        </View>
