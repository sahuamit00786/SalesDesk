        ...
        <div className={cn('mt-auto shrink-0 border-t px-2 py-3', SIDEBAR_BORDER)}>
          ...
          {!narrow ? (
            <>
              ...
              <p className="mt-1 flex items-center justify-center gap-1.5 text-center text-[10px] text-white/40">
                <a href="/privacy" target="_blank" rel="noopener noreferrer" className="hover:text-white/70 hover:underline">
                  Privacy
                </a>
                <span aria-hidden>·</span>
                <a href="/terms" target="_blank" rel="noopener noreferrer" className="hover:text-white/70 hover:underline">
                  Terms
                </a>
              </p>
            </>
