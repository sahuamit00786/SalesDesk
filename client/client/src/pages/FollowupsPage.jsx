...
export function FollowupsPage() {
  // Elevated (company_admin / workspace_admin / manager) → gets the employee
  // filter; others see only their own follow-ups (server-scoped).
  const isAdmin = useIsElevated()
  ...
  const { data: teamData } = useAssignableUsersQuery(undefined, { skip: !isAdmin })
