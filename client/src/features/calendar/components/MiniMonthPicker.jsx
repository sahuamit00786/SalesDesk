          ...
          return (
            <button
              ...
              className={cn(
                ...
                inRange && !isRangeStart && !isRangeEnd && 'bg-brand-100 text-brand-700 rounded-md',
                (isRangeStart || isRangeEnd) && 'bg-[var(--brand-primary)] text-white font-medium shadow-sm',
                isToday && !isSelected && 'text-brand-600 font-semibold bg-brand-50',
              )}
            >
              {format(day, 'd')}
